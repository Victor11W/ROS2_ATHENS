...
#include "stm_interfaces/msg/detail/stm_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm_interfaces::msg::STMControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm_interfaces::msg::STMControl & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stm_interfaces
max_serialized_size_STMControl(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const stm_interfaces::msg::STMControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm_interfaces::msg::STMControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _STMControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const stm_interfaces::msg::STMControl *>(
...
{
  return max_serialized_size_STMControl(full_bounded, 0);
}

static message_type_support_callbacks_t _STMControl__callbacks = {
  "stm_interfaces::msg",
  "STMControl",
...
static rosidl_message_type_support_t _STMControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_STMControl__callbacks,
...
{
  return &stm_interfaces::msg::typesupport_fastrtps_cpp::_STMControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm_interfaces, msg, STMControl)() {
  return &stm_interfaces::msg::typesupport_fastrtps_cpp::_STMControl__handle;
}
