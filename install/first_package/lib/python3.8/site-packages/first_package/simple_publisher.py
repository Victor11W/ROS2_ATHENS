...
class MinimalPublisher(Node):
    def __init__(self):
        ...
        super().__init__('node_11')  # <-- Replace 'NICKNAME' with your actual group number
        
        # Step 2: Create a publisher for your topic
        # Replace 'topic_ID' with a unique topic name (e.g., 'topic_1' for Group 1)
        self.publisher_ = self.create_publisher(FluidPressure, 'topic_2', 10)  # <-- Replace 'NICKNAME'
    ...
    def timer_callback(self):
        ...
        self.get_logger().info(f'Publishing: "{msg.fluid_pressure}"')
