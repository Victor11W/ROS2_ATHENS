...
{
  new (message_memory) first_interfaces::srv::AddTwoInts_Request(_init);
}

void AddTwoInts_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<first_interfaces::srv::AddTwoInts_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddTwoInts_Request_message_member_array[2] = {
  {
    ...
    offsetof(first_interfaces::srv::AddTwoInts_Request, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(first_interfaces::srv::AddTwoInts_Request, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddTwoInts_Request_message_members = {
  "first_interfaces::srv",  // message namespace
  "AddTwoInts_Request",  // message name
  2,  // number of fields
  sizeof(first_interfaces::srv::AddTwoInts_Request),
...
{
  return &::first_interfaces::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_interfaces, srv, AddTwoInts_Request)() {
  return &::first_interfaces::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Request_message_type_support_handle;
}
...
void AddTwoInts_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) first_interfaces::srv::AddTwoInts_Response(_init);
}

void AddTwoInts_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<first_interfaces::srv::AddTwoInts_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddTwoInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(first_interfaces::srv::AddTwoInts_Response, sum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddTwoInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(first_interfaces::srv::AddTwoInts_Response),
...
{
  return &::first_interfaces::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_interfaces, srv, AddTwoInts_Response)() {
  return &::first_interfaces::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers AddTwoInts_service_members = {
  "first_interfaces::srv",  // service namespace
  "AddTwoInts",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<first_interfaces::srv::AddTwoInts>()
...
get_service_type_support_handle<first_interfaces::srv::AddTwoInts>()
{
  ...
  auto service_type_support =
    &::first_interfaces::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::first_interfaces::srv::AddTwoInts_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::first_interfaces::srv::AddTwoInts_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_interfaces, srv, AddTwoInts)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<first_interfaces::srv::AddTwoInts>();
}
